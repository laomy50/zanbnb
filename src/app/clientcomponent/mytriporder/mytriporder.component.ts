...
@Component({
  selector: 'app-mytriporder',
  templateUrl: './mytriporder.component.html',
  styleUrl: './mytriporder.component.css'
})
export class MytriporderComponent {
  ...
  public getMyTransportOrders() {
    ...
    if (userId) {
      this.bookingService.getTripByUserId(userId).subscribe(
        (response: any[]) => {
