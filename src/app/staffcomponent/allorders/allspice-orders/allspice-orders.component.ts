...
@Component({
  selector: 'app-allspice-orders',
  templateUrl: './allspice-orders.component.html',
  styleUrl: './allspice-orders.component.css'
})
export class AllspiceOrdersComponent {
  ...
  ngOnInit(): void {
    ...
    this.getAllSpiceOrders();
  }

  // all rents
  public getAllSpiceOrders() {
    this.bookingService.getAllSpiceBookings()
